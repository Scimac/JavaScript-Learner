...
```js
	...
	num = 8;
	console.log(num)         // This gives a reference error
	```
...
- Variables declared with `const` **needs to be initailized with a value** as they cannot be reassigned a new value, coding such raises an error.
